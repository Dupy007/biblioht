					...
					<div className="main-menu-wrap">
						...
						<nav className="main-menu  ">
							<ul>
								...
								<li><NavLink to="/News">Nouveautés</NavLink></li>
								<li><NavLink to="/Shop">Livres</NavLink></li>
				...
				<div className="col-lg-12">
					...
					<div className="search-bar">
						<div className="search-bar-tablecell">
							...
							<NavLink to={{pathname:'/Search',aboutProps:{cle:this.state.recherche} }} > <button type="submit"> Recherche <i className="fas fa-search"></i></button></NavLink>
						</div>
					</div>
				</div>
			</div>
