...
var merge = (exports.merge = function merge(obj1, obj2, appendOnly) {
  ...
  if (obj1 === null || typeof obj1 !== "object") {
    throw new TypeError(
      "merge() - first parameter has to be an object, not " + typeof obj1 + ".",
    );
  }

  if (obj2 === null || typeof obj2 !== "object") {
    throw new TypeError(
      "merge() - first parameter has to be an object, not " + typeof obj2 + ".",
    );
  }
 ...
 */
var checkExpiredToken = (exports.checkExpiredToken = function checkExpiredToken(
  token_hash,
) {
